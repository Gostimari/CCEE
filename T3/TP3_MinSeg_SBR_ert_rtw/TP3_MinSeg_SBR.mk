###########################################################################
## Makefile generated for component 'TP3_MinSeg_SBR'. 
## 
## Makefile     : TP3_MinSeg_SBR.mk
## Generated on : Fri May 13 17:44:27 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TP3_MinSeg_SBR.elf
...
PRODUCT_NAME              = TP3_MinSeg_SBR
MAKEFILE                  = TP3_MinSeg_SBR.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Dylan/ONEDRI~1/UC/4_Ano/2_SEME~1/CCEE/TP3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/Dylan/DOCUME~1/MATLAB/R2021b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TP3_MinSeg_SBR.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/RASPlib/src -I$(START_DIR)/RASPlib/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/aIDE/hardware/arduino/avr/LIBRAR~1/Wire -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/aIDE/hardware/arduino/avr/LIBRAR~1/Wire/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/aIDE/hardware/arduino/avr/LIBRAR~1/Wire/src/utility -IC:/ProgramData/MATLAB/SupportPackages/R2021b/aIDE/hardware/arduino/avr/libraries/Wire/utility -I$(START_DIR)/TP3_MinSeg_SBR_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=256 -DMW_TIMERCOUNT=63661 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=4 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0 -D_RTT_OVERRUN_DIGITAL_PIN_=13
...
DEFINES_STANDARD = -DMODEL=TP3_MinSeg_SBR -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o encoder_arduino.o PWMFSelect.o Wire.o twi.o I2Cdev.o MPU6050.o MPU6050wrapper.o TP3_MinSeg_SBR.o TP3_MinSeg_SBR_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PWMFSelect.o : $(START_DIR)/RASPlib/blocks/../src/PWMFSelect.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


TP3_MinSeg_SBR.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/TP3_MinSeg_SBR.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TP3_MinSeg_SBR_data.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/TP3_MinSeg_SBR_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/TP3_MinSeg_SBR_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
